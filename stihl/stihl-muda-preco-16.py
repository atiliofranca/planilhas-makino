...
for index, linha_df1 in df1.iterrows():
    ...
    if pd.notna(valor_a_procurar) and valor_a_procurar in dados_consolidados:
        ...
        try:
            ...
            # --- MUDANÇA PRINCIPAL: NOVO CÁLCULO PARA PREÇOS DE VENDA ---
            
            # 1. 'Novo Pr. Venda 4' é a base, aplicando apenas o arredondamento
            ...
            valor_venda_3 = arredondamento_personalizado(valor_venda_2 * 0.98)  # -2% de Venda 2
            ...
            valor_venda_1 = valor_preco_encontrado
            valor_venda_2 = valor_preco_encontrado
            valor_venda_3 = valor_preco_encontrado
            valor_venda_4 = valor_preco_encontrado
            valor_venda_5 = valor_preco_encontrado
            valor_venda_6 = valor_preco_encontrado
            valor_venda_7 = valor_preco_encontrado
        ...
        # MUDANÇA: Atualiza cada coluna de venda individualmente
