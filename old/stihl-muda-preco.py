...
def letra_para_indice(letra):
    """Converte uma letra de coluna do Excel (A, B, ..., AA, AB) para um índice numérico (0, 1, ..., 26, 27)."""
    letra = letra.upper()
    indice = 0
    for char in letra:
...
# --- CONFIGURAÇÃO ---
nome_arquivo_1 = 'arquivo1-17pecas.csv'
nome_arquivo_2 = 'lista-sugerida-stihl.xlsx'
...
try:
    ...
    # MUDANÇA: Adicionado o parâmetro engine='openpyxl' para especificar o leitor de Excel
